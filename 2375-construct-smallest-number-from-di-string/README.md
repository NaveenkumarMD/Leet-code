...
<pre style="position: relative;"><strong>Input:</strong> pattern = "IIIDIDDD"
...
Note that "123414321" is not possible because the digit '1' is used more than once.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong>Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> pattern = "DDD"
